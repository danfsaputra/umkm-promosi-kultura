        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <div>
                <h1 className="text-sm sm:text-lg lg:text-xl font-bold text-gray-800">UMKM Kultura</h1>
                <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">Kerajinan Tangan Dari Daur Ulang</p>
              </div>
            </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-3 sm:mb-4 leading-tight">
                UMKM Kreatif Peduli Lingkungan<br />
                <span className="text-amber-600">UMKM Kultura</span><br />
              ...
              <div className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700">
                <p className="flex items-start gap-2">
                  ...
                  Produk daur ulang sampah berkualitas
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-amber-600 font-semibold">✓</span>
                  Vas, tas, dan taplak dari limbah kreatif
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-amber-600 font-semibold">✓</span>
                  Ramah lingkungan, penuh nilai seni lokal
                </p>
              </div>
            </div>
      ...
      <section id="produk" className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
            Produk daur ulang sampah berkualitas, Ramah lingkungan, penuh nilai seni lokal
          </p>
        </div>
            ...
            <div>
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm sm:text-base">+62 813-5027-5073</span>
                </div>
      ...
      <footer className="bg-gray-900 text-white py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          <div className="flex items-center justify-center gap-3 sm:gap-4 mb-3 sm:mb-4">
            ...
            <span className="text-base sm:text-lg font-semibold">UMKM Kultura</span>
          </div>
          <p className="text-gray-400 text-xs sm:text-sm">
            © 2025 UMKM Kultura. Dibuat dengan ❤️ untuk Lingkungan Bersih
          </p>
        </div>
      </footer>
